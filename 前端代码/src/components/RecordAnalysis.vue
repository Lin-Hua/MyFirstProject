<template>
  <div>
    <div style="width: 80%;height: 600px;border:1px solid rgb(180,180,180)" id="echartss"></div>
  </div>
</template>
...
//需要的话下面内容copy到主体代码块即可
        ...
        legend: {
          ...
          data: ['文史','小说', '科技','艺术','经济']  //注意要和数据的name相对应
        },
        //工具箱
        toolbox: {
          show: true,//显示工具箱
...
//数据
  ...
  created () {
    const _this = this
    axios.get('http://localhost:8082/superadmin/getRecordAnalysis').then(function (resp){
       _this.sum=resp.data
